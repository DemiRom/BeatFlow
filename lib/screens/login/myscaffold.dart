...
import 'package:beatflow/components/desktop/linux_header_bar.dart';
import 'package:beatflow/components/desktop/player_bar.dart';
import 'package:beatflow/components/desktop/side_menu.dart';
import 'package:beatflow/components/miniplayer.dart';
import 'package:beatflow/components/player.dart';
import 'package:beatflow/screens/browsing/home_page.dart';
import 'package:beatflow/screens/browsing/search.dart';
...
import 'package:beatflow/screens/login/bottomnavbar.dart';
import 'package:beatflow/screens/login/drawer.dart';
...
class RootScreen extends StatelessWidget {
  ...
  Future<Image> loadIcon() async {
    return const Image(image: AssetImage('assets/icon/beatflow.png'));
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            //   size: 36.0,
            // ),
            Image.asset('assets/icon/beatflow.png',
                width: 144, height: 144, fit: BoxFit.fill),
            const SizedBox(height: 20.0),
            const Text(
              "Flow",
              style: TextStyle(
