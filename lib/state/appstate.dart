...
import 'package:beatflow/state/appcommands.dart';
import 'package:beatflow/state/database/database.dart';
import 'package:beatflow/state/networkstate.dart';
import 'package:beatflow/state/playerstate.dart';
import 'package:beatflow/subsonic/context.dart';
import 'package:beatflow/subsonic/models/album.dart';
...
class ServerData {
  final String uri = "https://music.dieseldemi.com";
  final String username;
  final String password;
  ...
  static ServerData initialState() => ServerData(username: '', password: '');
