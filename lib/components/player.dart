...
import 'package:beatflow/components/cover_art.dart';
import 'package:beatflow/screens/login/album_page.dart';
...
import 'package:beatflow/state/player_task.dart';
import 'package:beatflow/state/playerstate.dart';
import 'package:beatflow/state/queue.dart';
...
import 'package:beatflow/utils/duration.dart';
...
class _PlayerViewModelFactory
    extends VmFactory<AppState, PlayerView, PlayerViewModel> {
                        ...
                        child: GestureDetector(
                          ...
                          child: FittedBox(
                            child: Transform.rotate(
                                angle: vm.position.inSeconds.toDouble(),
